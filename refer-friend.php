            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cards.html"><i class="bi bi-laptop-fill"></i>Digital Marketing
                            and SEO</a>
                        ...
                        <a class="collapse-item" href="services/website-design.php"><i
                                class="bi bi-laptop-fill"></i>Website
                            Design</a>
            ...
            <div class="container mb-4">
                <div class="service-wrapper">
                    <div class="service-content-left pl-4">
                        ...
                        <a href="#" class="btn btn-primary bg-transparent px-4 py-3">Register & Start To Earn</a>
                    </div>
                    <div class="service-content-right pr-5">
                        <img src="img/contact-us.svg" alt="Services Images" />
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="affilate-step p-4">
                            ...
                            <div>
                                ...
                                <p>
                                    Join the group of individuals, publications, bloggers, and innovators who are
                                    already
                                    making money with the Murphy's Technology Affiliates Program.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 ">
                        <div class="affilate-step p-4">
                            ...
                            <div>
                                <h3 class="my-3">Recommend</h3>
                                <p>
                                    Share our services with your audience. We have customised linking tools for
                                    individual
                    ...
                    <div class="col-md-4 ">
                        <div class="affilate-step p-4">
                            ...
                            <div>
                                <h3 class="my-3">Earn</h3>
                                <p>
                                    Earn up to 10% in affiliate commissions from our qualifying services. Lets grow
                                    together
                                    !!!!
                                </p>
                            </div>
                                ...
                                <form>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="email" class="form-control form-control-user" id="phoneNum"
                                                required="" placeholder="Enter Email" />
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="lastName" class="fw-600">Phone Number</label>
                                            <input type="number" class="form-control form-control-user" id="subject"
                                                required="" placeholder="Enter Phone Number" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label for="businessOption" class="fw-600">Are you a business or individual?
                                            </label>
                                            <select name="businessOption" id="surveyInfo"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label for="businessOption" class="fw-600">Which products are you interested
                                                in offering?
                                            </label>
                                            <div class="d-flex justify-content-between">
                                                <div class="from-group_radio" id="radio">
                                                    <div>
                                                        <input type="radio" id="websiteDesign" name="product_option"
                                                            value="Website Design">
                                                        <label for="html">website Design/development</label>
                                                    </div>
                                                    <div id="radio">
                                                        <input type="radio" id="websiteDevelopment"
                                                            name="product_option" value="Website Development">
                                                        <label for="html">website hosting/domain names</label>
                                                    </div>
                                                ...
                                                <div class="from-group_radio" id="radio">
                                                    ...
                                                    <div id="radio">
                                                        <input type="radio" id="webHosting" name="product_option"
                                                            value="Web Hosting">
                                                        <label for="html">seo service</label>
                                                    </div>
                                                    <div id="radio">
                                                        <input type="radio" id="other" name="product_option"
                                                            value="other">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="message" class="d-block fw-600">Message</label>
                                            <textarea name="mesage" id="message" class="w-100 p-3" cols="30" rows="5"
                                                placeholder="Write Message"></textarea>
                                        </div>
                                    </div>
                                    <div class="d-flex mt-4 justify-content-center">
                                        <input type="submit" value="Submit" class="btn-primary btn px-5 py-3" />
                                    </div>
                                </form>
                            </div>
                        </div>
