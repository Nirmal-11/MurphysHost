        ...
        <div id="content-wrapper" class="d-flex flex-column discount-wrapper">
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="row discount-wrapper">
                        <div class="col-12 text-center my-3">
                            <img src="./img/discount.jpg" class="mb-2" alt="Discount Image">
                            <div class="my-4">
                                <h2 class="h3  h-primary">Post your review on Facebook or Google and
                                    <br />get
                                    a 20% off
                                    coupon!
                                </h2>
                ...
                <div class="container review-container">
                    ...
                    <div>
                        <a href="#" class="review-card google-card">
                            <img src="./img/google.png" class="mr-2" alt="google image">
                            <div class="ml-1">
                    ...
                    <div class=" mt-2">
                        <a href="#" class="review-card facebook-card">
                            <img src="./img/facebook.png" class="mr-2" alt="facebook image">
                            <div class="ml-1">
                                <p class="mb-0 fs-14">Facebook Rating</p>
                                <div class="d-flex">
                                    <h4 class="mb-0 mr-2">4.9</h4>
                                    <div>
                                        <i class="fas fa-star"></i>
