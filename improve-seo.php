...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="refer-friend.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container mb-4">
                    <div class="mb-4 mt-5">
                        <h1 class="h2 fw-700 mb-1 text-gray-900">Improve SEO</h1>
                ...
                <div class="container mb-4">
                    <div class="service-wrapper px-4 py-3">
                        <div class="service-content-left pl-4">
                            <h2>Improve SEO</h2>
                            <p>
                                SEO and Digital Marketing packages customized to your business goals, designed to
                                increase your digital footprint and online visibility making it easier for potential
                                leads to find you online.
                            </p>
                        </div>
                        <div class="service-content-right pr-5">
                            <img src="./img/improve-seo.png" alt="Services Images" />
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body px-4 py-5">
                                    ...
                                    <div class="purchase-features">
                                        <ul>
                                            <li><i class="bi bi-check2-circle"></i>3 web Pages</li>
                                            <li>
                                                <i class="bi bi-check2-circle"></i>Website Audit
                                            </li>
                                            <li><i class="bi bi-check2-circle"></i>Keywords Research</li>
                                            <li>
                                                <i class="bi bi-x-circle"></i>Image Optimization
                                            </li>
                                            <li>
                                                <i class="bi bi-check2-circle"></i>4 Keywords
                                            </li>
                        ...
                        <div class="purchase-plan-service">
                            <div class="card shadow mb-4">
                                <div class="card-body px-4 py-5">
                                    ...
                                    <h2 class="h3 mb-3">Premium Plan</h2>
                                    <div class="purchase-features">
                                        <ul>
                                            <li><i class="bi bi-check2-circle"></i>5 web Pages</li>
                                            <li>
                                                <i class="bi bi-check2-circle"></i>Website Audit
                                            </li>
                                            <li><i class="bi bi-check2-circle"></i>Keywords Research</li>
                                            <li>
                                                <i class="bi bi-check2-circle"></i>Image Optimization
                                            </li>
                                            <li>
                                                <i class="bi bi-check2-circle"></i>6 Keywords
                                            </li>
                        ...
                        <div class="purchase-plan-service">
                            <div class="card shadow mb-4">
                                <div class="card-body px-4 py-5">
                                    ...
                                    <h2 class="h3 mb-3">Enterprise Plan</h2>
                                    <div class="purchase-features">
                                        <ul>
                                            <li><i class="bi bi-check2-circle"></i>6+ web Pages</li>
                                            <li>
                                                <i class="bi bi-check2-circle"></i>Pro Website Audit
                                            </li>
                                            <li><i class="bi bi-check2-circle"></i>Keywords Research</li>
                                            <li>
                                                <i class="bi bi-check2-circle"></i>Image Optimization
                                            ...
                                            <li>
                                                <i class="bi bi-check2-circle"></i>9 Keywords
                                            </li>
