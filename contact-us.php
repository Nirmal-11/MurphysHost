      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="collapse-inner rounded">
            ...
            <a class="collapse-item" href="services/website-design.php"><i class="bi bi-laptop-fill"></i>Website
              Design</a>
            <a class="collapse-item" href="services/web-hosting.php"><i class="bi bi-laptop-fill"></i>Web Hosting</a>
          ...
          <div class="col-md-4 contact-info">
            <div class="card shadow mb-4">
              <div class="card-body mt-5">
                ...
                <div class="contact-info-content">
                  <a href="mailto:support@murphystechnology.com.au">support@murphystechnology.com.au</a>
                </div>
              </div>
            </div>
          </div>
                ...
                <form>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      ...
                      <input type="text" class="form-control form-control-user" id="phoneNum" required=""
                        placeholder="Enter phone" />
                    </div>
                    <div class="col-sm-6">
                      <label for="lastName" class="fw-600">Subject</label>
                      <input type="text" class="form-control form-control-user" id="subject" required=""
                  ...
                  <div class="d-flex mt-4 justify-content-center">
                    <input type="submit" value="Send Message" class="btn-primary btn px-4 py-3" />
                  </div>
                </form>
              </div>
            </div>
