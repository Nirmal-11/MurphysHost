      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="collapse-inner rounded">
            ...
            <a class="collapse-item active" href="#"><i class="bi bi-laptop-fill"></i>Website Design</a>
            <a class="collapse-item" href="./web-hosting.php"><i class="bi bi-laptop-fill"></i>Web Hosting</a>
        ...
        <div class="container mb-4">
          <div class="service-wrapper px-4 py-3">
            <div class="service-content-left pl-4">
              <h2 class="fw-500">Website Design</h2>
              <p>
                Provide us your business details and we will create
                easy-to-update and feature-rich fully customized web design
                for your business. No issue, we will convert the design into
                neat, hand-coded, W3C standards, semantic, SEO optimized and
                cross-browser compatible.
              </p>
            </div>
            <div class="service-content-right pr-5">
              <img src="../img/website-design.png" alt="Services Images" />
            </div>
          </div>
        </div>
      </div>
